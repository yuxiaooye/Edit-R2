...
def pipeline_with_logprob(
    ...
    # Assuming 10 denoising steps total, sde_window_size=2, sde_window_range=(0,10), sde_window can be (0,2),(1,3),(2,4),...
    if sde_window_size > 0:
        ...
        # The last step is close to the image; the Gaussian is very sharp with high probability, prone to precision overflow — excluded from training
